...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           ...
           'BottleNeck', 'Blocks',
           'Partial_FDConv', 'Bottleneck_PFDConv', 'C2f_PFDConv')
...
# ==============================================================================
# HFRT-DETR Proposed Modules: PFDConv and C2f_PFDConv
# ==============================================================================

class Partial_FDConv(nn.Module):
    """
    Couples Partial Convolution (PConv) with Frequency Domain Dynamic Convolution (FDConv).
    As described in Section 3.2 of the HFRT-DETR paper.
    """
    ...
    def __init__(self, dim, n_div=4, forward='split_cat'):
        ...
        self.partial_conv3 = FDConv(self.dim_conv3, self.dim_conv3, kernel_size=3, stride=1)
...
class Bottleneck_PFDConv(Bottleneck):
    """
    PFD-Bottleneck utilizing Partial_FDConv.
    """

    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
        super().__init__(c1, c2, shortcut, g, k, e)
        # 将原版 Bottleneck 的标准卷积替换为我们的 PFDConv
...
class C2f_PFDConv(C2f):
    """
    C2f module incorporating PFD-Bottlenecks for frequency-aware feature extraction.
    """
